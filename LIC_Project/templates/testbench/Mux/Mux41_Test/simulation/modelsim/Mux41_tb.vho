...
-- C	=>  Location: PIN_A2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- A	=>  Location: PIN_C5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D	=>  Location: PIN_B5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\M~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \M~0_combout\ = (\S[1]~input_o\ & (((\S[0]~input_o\)))) # (!\S[1]~input_o\ & ((\S[0]~input_o\ & (\B~input_o\)) # (!\S[0]~input_o\ & ((\A~input_o\)))))
...
\M~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \M~1_combout\ = (\S[1]~input_o\ & ((\M~0_combout\ & (\D~input_o\)) # (!\M~0_combout\ & ((\C~input_o\))))) # (!\S[1]~input_o\ & (\M~0_combout\))
