...
ARCHITECTURE Structural OF Serial_Receiver IS
	...
	-- Generic version of the Shift Register
	...
	-- Generic version of the XNOR gate
	COMPONENT EQUALS IS
...
BEGIN
	...
	--U_Shift_Register : Shift_Reg PORT MAP(
	--	Data => SDX,
	--	clk => SCLK,
	--	E => WR_signal,
	--	D => Data,
	...
	U_XNOR5 : EQUALS PORT MAP(
		X => COUNTER_EXIT_signal,
		Q => DFLAG_signal,
		match => "0101"
	);

	U_XNOR6 : EQUALS PORT MAP(
		X => COUNTER_EXIT_signal,
		Q => PFLAG_signal,
		match => "0110"
	);
	...
	U_PARITY_CHECK : Parity_Check PORT MAP(
		...
		init => INIT_signal,
		serialClock => SCLK_signal,
		serialData => SDX_signal
	);
